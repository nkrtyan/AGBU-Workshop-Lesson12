...
user = Register('ABgdesxf', 'a@gmail.com', 'abchs1Afd', '1000', 'admin')
user2 = Register('ABgdesxf', 'agmail.com', 'abchs1Afd', '1000', 'admin')
user3 = Register('ABgdesxf', 'a@gmail.com', 'abchs1Afd', '1000', 'admin')
 
print(user3.register_user())
